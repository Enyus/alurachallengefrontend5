      ...
      return (produtoMostrado = (
        <section className={styles.produto__container}>
          ...
          <div className={styles.produto__subcontainer}>
            <h2 className={styles.produto__titulo}>{produtos[0].produto}</h2>

            <p className={styles.produto__preco}>
              {formatter.format(produtos[0].preco / 100)}
            </p>

            <p className={styles.produto__descricao}>{produtos[0].descricao}</p>
          </div>
        </section>
      ));
    } else {
